...
gender.style.textShadow = `0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}`

for (const f of fa) {
f.style.textShadow = `0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}, 0 0 ${storedPkmnColor === "white" || storedPkmnColor === "yellow" ? "1px" : "10px"} ${storedPkmnColor}`
}

async function getSprites() {
    try {
        const response = await fetch(`https://pokeapi.co/api/v2/pokemon/${storedPokemonName}`)
