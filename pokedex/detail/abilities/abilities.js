    ...
    if (abilitiesData.length === 0) {
      ...
      abilitiesData.forEach((ability) => {
        if (storedPkmnColor === "white") {
          abilitiesContainer.innerHTML += `
        <div class="abilities-container" style="border: 0.3rem ridge ${storedPkmnColor}; text-shadow: 0 0 2px ${storedPkmnColor}, 0 0 2px ${storedPkmnColor}, 0 0 2px ${storedPkmnColor}, 0 0 2px ${storedPkmnColor}; box-shadow: 0 0 10px ${storedPkmnColor}, 0 0 10px ${storedPkmnColor}; background: ${rgbaColors[storedPkmnColor]}">
      ...
      `;
          ...
          abilitiesContainer.innerHTML += `
        <div class="abilities-container" style="border: 0.3rem ridge ${storedPkmnColor}; text-shadow: 0 0 3px ${storedPkmnColor}, 0 0 3px ${storedPkmnColor}, 0 0 3px ${storedPkmnColor}, 0 0 3px ${storedPkmnColor}; box-shadow: 0 0 10px ${storedPkmnColor}, 0 0 10px ${storedPkmnColor}; background: ${rgbaColors[storedPkmnColor]}">
          <p class="ability-id">Ab. ${ability.id}</p>
          <p class="ability-name">${ability.name.split("-").join(" ")}</p>
        </div>
      `;
          ...
          abilitiesContainer.innerHTML += `
        <div class="abilities-container" style="border: 0.3rem ridge ${storedPkmnColor}; text-shadow: 0 0 5px ${storedPkmnColor}, 0 0 5px ${storedPkmnColor}, 0 0 5px ${storedPkmnColor}, 0 0 5px ${storedPkmnColor}; box-shadow: 0 0 10px ${storedPkmnColor}, 0 0 10px ${storedPkmnColor}; background: ${rgbaColors[storedPkmnColor]}">
          <p class="ability-id">Ab. ${ability.id}</p>
          <p class="ability-name">${ability.name.split("-").join(" ")}</p>
        </div>
      `;
